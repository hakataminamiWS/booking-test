                ...
                <v-card>
                    ...
                    <v-card-text>
                        ...
                        <v-card variant="text" class="mb-4">
                            ...
                            <v-card-text class="pa-0 text-body-1">{{ new Date(contract.start_date).toLocaleDateString()
                            }}</v-card-text>
                        </v-card>

                        <v-card variant="text" class="mb-4">
                            <v-card-title class="pa-0 text-subtitle-2 text-grey-darken-1">契約終了日</v-card-title>
                            <v-card-text class="pa-0 text-body-1">{{ new Date(contract.end_date).toLocaleDateString()
                            }}</v-card-text>
                        </v-card>
                    </v-card-text>
                </v-card>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        ...
                        <v-card variant="text" class="mb-4">
                            ...
                            <v-card-text class="pa-0 text-body-1">{{ contract.application.customer_name }}</v-card-text>
                        </v-card>
