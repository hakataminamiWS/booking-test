                ...
                <v-card class="mt-4">
                    ...
                    <v-card-text>
                        ...
                        >
                            ...
                            <template
                                v-slot:item.requires_staff_assignment="{ item }"
                            >
                                <v-chip
                                    :color="
                            ...
                            <template
                                v-slot:item.cancellation_deadline_minutes="{
                                    item,
                                }"
                            >
                                {{
                            ...
                            <template
                                v-slot:item.booking_deadline_minutes="{ item }"
                            >
                                {{
                            ...
                            <template v-slot:item.actions="{ item }">
                                <v-btn
                                    color="primary"
                                    :href="`/owner/shops/${props.shop.slug}/menus/${item.id}/edit`"
                                    >編集
                                </v-btn>
                            </template>
                        </v-data-table-server>
