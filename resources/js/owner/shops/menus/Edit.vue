...
interface Menu {
    ...
    duration: number;
    description: string;
    requires_staff_assignment: number;
    requires_cancellation_deadline: number;
    cancellation_deadline_minutes: number;
    requires_booking_deadline: number;
...
const formData = ref({
    ...
    price: props.menu.price as number | string,
    duration: props.menu.duration as number | string,
    ...
    cancellation_deadline_minutes: props.menu.cancellation_deadline_minutes as number | string,
    requires_booking_deadline: props.menu.requires_booking_deadline,
    booking_deadline_minutes: props.menu.booking_deadline_minutes as number | string,
    staff_ids: props.menu.staffs.map((staff) => staff.id),
    option_ids: props.menu.options.map((option) => option.id),
});
