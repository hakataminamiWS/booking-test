<template>
    <OwnerLayout :shop="shop" currentPage="bookers">
        <v-container>
            <v-row>
                <v-col cols="12">
                    <v-card>
                        <v-card-title
                            ...
                            <v-btn
                                   ...
                                   :href="`/owner/shops/${props.shop.slug}/bookers/create`"
                        ...
                        <v-card-text>
                            ...
                            <v-data-table-server
                                ...
                                <template v-slot:item.actions="{ item }">
                                    <v-btn
                                           color="primary"
                                           :href="`/owner/shops/${props.shop.slug}/bookers/${item.id}/edit`">編集する
                                    </v-btn>
                                </template>
                            </v-data-table-server>
                        </v-card-text>
...
const loadItems = async (options: Options) => {
    ...
    const apiUrl = `/owner/api/shops/${props.shop.slug
        }/bookers?${params.toString()}`;
    history.pushState(
        null,
        "",
        `/owner/shops/${props.shop.slug}/bookers?${params.toString()}`
    );
