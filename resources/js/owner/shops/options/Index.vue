                ...
                <v-card>
                    <v-card-title
                        ...
                        <v-btn
                               ...
                               :href="`/owner/shops/${props.shop.slug}/options/create`"
                    ...
                    <v-card-text>
                        ...
                        <v-data-table-server
                            ...
                            <template v-slot:item.actions="{ item }">
                                <v-btn
                                       color="primary"
                                       :href="`/owner/shops/${props.shop.slug}/options/${item.id}/edit`">編集する
                                </v-btn>
                            </template>
                        </v-data-table-server>
                    </v-card-text>
...
const sortableColumns = ref([
    { text: "オプション名", value: "name" },
    { text: "追加料金", value: "price" },
    { text: "追加所要時間", value: "additional_duration" },
...
const headers: Headers = [
    { title: "オプション名", key: "name", sortable: false },
    { title: "追加料金", key: "price", sortable: false },
    { title: "追加所要時間", key: "additional_duration", sortable: false },
