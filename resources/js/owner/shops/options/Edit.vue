<template>
    <OwnerLayout :shop="props.shop" currentPage="options">
        <v-container>
                        ...
                        <v-card-text>
                            ...
                            <form :action="formAction" method="POST">
                                ...
                                <v-card-actions>
                                    <v-btn
                                           color="error"
                                           @click="deleteDialog = true">削除する</v-btn>
                                    <v-spacer></v-spacer>
                                    <v-btn
                                           type="submit"
                                           color="primary"
                                           :disabled="!isFormValid">更新する</v-btn>
                                </v-card-actions>
                            </form>
                        </v-card-text>
                    </v-card>
...
const formData = ref({
    ...
    price: props.option.price as number | string,
    additional_duration: props.option.additional_duration as number | string,
