                    ...
                    <v-card>
                        ...
                        <v-card-text>
                            ...
                            <v-data-table-server
                                ...
                                <template
                                          v-slot:item.accepts_online_bookings="{
                                            item,
                                        }">
                                    <v-chip
                    ...
                    <v-card-text>
                        <v-row v-for="filter in filters" :key="filter.id" align="center">
                            ...
                            <v-col cols="7">
                                ...
                                " v-model="filter.value" label="値" dense hide-details></v-text-field>
                                <v-select v-if="
                                    getColumnType(filter.column) ===
                                    'select'
                                " v-model="filter.value" :items="getColumnItems(filter.column)" label="値" dense
...
const filterableColumns = ref([
    { text: "店舗ID", value: "slug", type: "text" },
...
const loadItems = async (options: Options) => {
    ...
    const apiUrl = `/owner/api/shops?${params.toString()}`;
    history.pushState(null, "", `/owner/shops?${params.toString()}`);
...
const headers: Headers = [
    { title: "店舗ID", key: "slug", sortable: false },
    { title: "店舗名", key: "name", sortable: false },
    { title: "受付状況", key: "accepts_online_bookings", sortable: false },
