<template>
    <BookerLayout :shop="shop">
        <v-container class="container-width-600">
                    ...
                    <v-card variant="text">
                        <v-card-text>
                            <div class="d-flex justify-space-around text-center">
                                ...
                                <div>
                                    <div class="text-caption text-grey">予約回数</div>
                                    <div class="text-h6 font-weight-bold">
            ...
            <v-row>
                <v-col cols="12">
                    <v-card title="メニュー" variant="text">
                        <v-list>
                            <v-list-item
                                         title="新規予約"
                                         subtitle="新しい予約を行います"
            ...
            <v-row>
                <v-col cols="12">
                    <v-card title="アカウント" variant="text">
                        <v-card-actions>
                            <v-btn
                                   variant="text"
                                   color="error"
            ...
            <form
                  ...
                  style="display: none;">
                <input type="hidden" name="_token" :value="csrfToken" />
                <input type="hidden" name="redirect_to" :value="`/shops/${shop.slug}`" />
            </form>
        </v-container>
    </BookerLayout>
</template>
