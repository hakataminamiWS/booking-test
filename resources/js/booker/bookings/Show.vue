<template>
    <BookerLayout :shop="shop" :backLink="`/shops/${shop.slug}/booker/bookings`" backLabel="予約履歴">
                ...
                <v-col cols="12">
                    <v-card>
                        ...
                        <v-card-text class="pt-4">
                            ...
                            <v-card variant="text" class="px-0 mb-4">
                                <v-card-title class="pa-0 text-subtitle-2 text-grey-darken-1">合計金額（税込）</v-card-title>
