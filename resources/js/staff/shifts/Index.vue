                                    ...
                                    <tbody>
                                        <tr
                                            ...
                                            <td
                                                ...
                                                <!-- Others: Non-clickable Text -->
                                                <div v-else
                                                     class="d-block pa-4 text-decoration-none text-grey-lighten-1">
                                                    <span>
                                                        {{
                                                            item.statuses[staff.id] ===
                                                                "entered"
...
// --- URL Computations ---
// const staffsIndexUrl = computed(() => `/shops/${props.shop.slug}/staff`); // Back to dashboard instead
...
const getShiftEditUrl = (weekStartDate: string) => {
    return `/shops/${props.shop.slug}/staff/shifts/edit?date=${weekStartDate}`;
};
